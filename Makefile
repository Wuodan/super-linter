...
SUPER_LINTER_TEST_CONTAINER_URL := "ghcr.io/wuodan/super-linter:${IMAGE_PREFIX}latest"
else
SUPER_LINTER_TEST_CONTAINER_URL := ${CONTAINER_IMAGE_ID}
endif
...
docker: docker-build-check check-github-token ## Build the container image
	...
	DOCKER_BUILDKIT=1 docker buildx build --load \
		...
		--cache-from type=registry,ref=ghcr.io/wuodan/super-linter:${IMAGE_PREFIX}latest-buildcache \
		--cache-from type=registry,ref=ghcr.io/wuodan/super-linter:latest-buildcache-base_image \
		--cache-from type=registry,ref=ghcr.io/wuodan/super-linter:latest-buildcache-clang-format \
		--cache-from type=registry,ref=ghcr.io/wuodan/super-linter:latest-buildcache-python-builder \
		--cache-from type=registry,ref=ghcr.io/wuodan/super-linter:latest-buildcache-npm-builder \
		--cache-from type=registry,ref=ghcr.io/wuodan/super-linter:latest-buildcache-tflint-plugins \
		--cache-from type=registry,ref=ghcr.io/wuodan/super-linter:latest-buildcache-lintr-installer \
		--cache-from type=registry,ref=ghcr.io/wuodan/super-linter:latest-buildcache-powershell-installer \
		--cache-from type=registry,ref=ghcr.io/wuodan/super-linter:latest-buildcache-php-linters \
		--cache-from type=registry,ref=ghcr.io/wuodan/super-linter:latest-buildcache-ruby-installer \
